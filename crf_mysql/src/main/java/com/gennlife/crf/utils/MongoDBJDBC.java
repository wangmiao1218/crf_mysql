...
public class MongoDBJDBC {
	...
	/**
	 * @Title: ConnectYantaiMongodb
	 * @Description: 连接烟台测试环境mongodb数据库
	 * @return: void
	 * @throws
	 */
	public static MongoDatabase ConnectYantaiMongodb() {
		...
		try {
			...
			// 连接到数据库
			mongoDatabase = mongoClient.getDatabase("CRF_Model");
	...
	/**
	 * @Title: ConnectYantaiMongodb(官方文档和源代码均建议使用MongoClient类，而且，在不久的将来，会废弃Mongo类。)
	 * @Description: 连接烟台测试环境mongodb数据库
	 * @return: void
	 * @throws
	 */
	public static DB ConnectYantaiMongo() {
