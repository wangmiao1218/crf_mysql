...
public class RandomValue {
	...
	*/
	...
	/** 
	* @Title: randomHomeAddress 
	* @Description: 返回地址
	* @author: wangmiao
	* @Date: 2018年6月28日 下午12:22:54 
	* @return: String
	* @throws 
	*/
	public static String randomHomeAddress() {
