 ...
 */
public class Yantai_Zy_AddZysqk {

	private static final Logger logger = LoggerFactory.getLogger(Yantai_Zy_AddZysqk.class);

	/** 
	 * @Title: zy_AddRysqk
	 * @Description: 添加住院_住院时情况
	 ...
	 * @throws 
	 */
	public static String zy_AddZysqk(PhantomJSDriver driver, String xpath) throws Exception {
		// 日志
		logger.debug("住院时情况");
		...
		// 添加住院时情况
		driver.findElementByXPath(".//*[@id='crf-data-tree_9_span']").click();
