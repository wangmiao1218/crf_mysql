	...
	*/
	...
	public String addCrfTemplateAnzhen_ZyWithoutHzxx() throws Exception {
		...
		if ("登陆成功".contains(value)) {
			...
			//就诊－住院与诊断
			AnzhenMethodByDriverAndIdXpath.globalMethod_Enum_MultiSelect(driver, "crf-data-tree_17_span", crfTemplateAnzhenService.getCrfTemplateAnzhenListByBaseName("就诊－住院与诊断"));
